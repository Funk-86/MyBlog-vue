...
// 博客管理员 - 仪表盘统计卡片（与需求文档一致）
export const PANE_LIST: Array<DashboardPanel> = [
  { title: '文章总数', number: '-', upTrend: '较昨日', leftType: 'echarts-line' },
  { title: '评论总数', number: '-', downTrend: '较昨日', leftType: 'echarts-bar' },
  { title: '今日访问量', number: '-', downTrend: '较昨日', leftType: 'icon-usergroup' },
  { title: '待审核帖子', number: '-', downTrend: '-', leftType: 'icon-file-paste' },
];
